...
var CartSub = (_temp2 = _class = function (_BaseComponent) {
  _inherits(CartSub, _BaseComponent);
  ...
  function CartSub() {
    ...
    _classCallCheck(this, CartSub);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CartSub.__proto__ || Object.getPrototypeOf(CartSub)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["cartClass", "showEidtBox", "isLogin", "isFixedBar", "systemInfo", "fetchCart", "commoditys", "editSkuData", "isFetching"], _this.config = {
      navigationBarTitleText: '购物车',
      backgroundColor: '#f2efef',
      disableScroll: true
    }, _this.onViewScroll = function (e) {
      _this.pageScrollFn && _this.pageScrollFn(e.detail.scrollTop);
    }, _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(CartSub, [{
    key: "_constructor",
    value: function _constructor() {
      _get(CartSub.prototype.__proto__ || Object.getPrototypeOf(CartSub.prototype), "_constructor", this).apply(this, arguments);
      this.state = {
        isLogin: Boolean((0, _util.getLoginStatus)()),
        isFixedBar: false,
        systemInfo: {}
      };
    ...
    value: function componentDidShow() {
      var isLogin = Boolean((0, _util.getLoginStatus)());
...
var CartSub__Connected = (0, _index3.connect)(function (_ref2) {
  var cart = _ref2.cart,
      home = _ref2.home;
  return {
...
exports.default = CartSub__Connected;

Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(CartSub__Connected, true));